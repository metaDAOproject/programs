...
import {
  getDaoTreasuryAddr,
  getProposalAddr,
} from "../../autocrat/v0.5/pda.js";
import { AutocratClient } from "../../autocrat/v0.5/AutocratClient.js";
...
export class SharedLiquidityManagerClient {
  ...
  //           true
  //         ),
  //         conditionalVaultProgram: CONDITIONAL_VAULT_v0_4_PROGRAM_ID,
  //         passBaseMint,
  //         failBaseMint,
  //         passQuoteMint,
  //         failQuoteMint,
  ...
  //         slPoolSigner,
  //       },
  //       autocratEventAuthority: getEventAuthorityAddr(AUTOCRAT_V0_5_PROGRAM_ID)[0],
  //       dao,
  //       autocratProgram: AUTOCRAT_V0_5_PROGRAM_ID,
