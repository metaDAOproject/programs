...
verify_local() {
    ...
    PROGRAM_ID=$2
    FEATURES=$3
    solana-verify verify-from-repo --remote -um --program-id $PROGRAM_ID https://github.com/metaDAOproject/futarchy --library-name $PROGRAM_NAME -b ellipsislabs/solana:1.17.31 -- --features $FEATURES
}
