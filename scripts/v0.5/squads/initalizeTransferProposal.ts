...
// Configuration
const DAO_ADDRESS = new PublicKey("7AivcS5Sm3uneG7EKtjAmmgWeQ653v6B1Uzc3JiYWihY");
...
async function main() {
  ...
  const tx = new Transaction().add(createRecipientAtaIx, vaultTxCreateIx, proposalCreateIx);
