 ...
 *
 * The accumulator + crank code was copied out of apps/accelerated-cranker,
 * which logs via pino as `log.info(obj, msg)` / `log.child({ module })`.
 * This shim keeps those call sites unchanged while printing readable lines
 * to the console for a standalone one-off run.
 */
