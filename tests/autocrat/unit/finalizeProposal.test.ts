...
import { ComputeBudgetProgram, PublicKey, Transaction, TransactionMessage } from "@solana/web3.js";
...
export default function suite() {
  ...
  it("passes proposals when Pass TWAP > Fail TWAP", async function () {
    ...
    const { passAmm, passBaseMint, passQuoteMint, failAmm } = this.autocratClient.getProposalPdas(proposal, META, USDC, dao);
