...
pub use crate::common::conditional_vault;
...
impl FuzzTest {
    pub fn airdrop_accounts(&mut self) {
        ...
        self.trident
            .airdrop(&self.staker.pubkey(), TEST_AIRDROP_SOL * LAMPORTS_PER_SOL);
        self.trident
            .airdrop(&self.proposer.pubkey(), TEST_AIRDROP_SOL * LAMPORTS_PER_SOL);
    }
    ...
    pub fn initial_setup(&mut self) {
        ...
        let staker_base_ata = token::initialize_associated_token_account(
            &mut self.trident,
            self.payer.pubkey(),
            self.base_meta,
            self.staker.pubkey(),
