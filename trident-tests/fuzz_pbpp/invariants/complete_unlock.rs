...
impl FuzzTest {
    pub fn verify_complete_unlock_invariants(
        ...
        invariant_eq!(
            ...
            pre_pp.performancePackageTokenVault,
        ...
        invariant!(time_passed > 0, "time_passed must be > 0 for TWAP division");
            ...
            .enumerate()
        {
            ...
            invariant_eq!(
                post_t.priceThreshold,
                exp_t.priceThreshold,
