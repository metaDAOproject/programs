...
import {
  ConditionalVault as ConditionalVaultIDLType,
...
export class ConditionalVaultClient {
  ...
  public readonly vaultProgram: Program<ConditionalVaultIDLType>;
  ...
  constructor(
    ...
    this.vaultProgram = new Program<ConditionalVaultIDLType>(
      ConditionalVaultIDL,
