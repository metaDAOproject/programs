...
import {
  AMM_V0_3_PROGRAM_ID,
  AUTOCRAT_V0_3_PROGRAM_ID,
  CONDITIONAL_VAULT_V0_3_PROGRAM_ID,
  MAINNET_USDC,
  USDC_DECIMALS,
} from "../../constants.js";
import { InstructionUtils } from "../../utils.js";
import { DEFAULT_CU_PRICE, MaxCUs } from "./cu.js";
import { getDaoTreasuryAddr, getProposalAddr } from "./pda.js";
import { getAmmAddr, getAmmLpMintAddr } from "../../amm/v0.3/pda.js";
import {
  getVaultAddr,
  getVaultFinalizeMintAddr,
  getVaultRevertMintAddr,
} from "../../conditional_vault/v0.3/pda.js";
import { ConditionalVaultClient } from "../../conditional_vault/v0.3/index.js";
import { AmmClient } from "../../amm/v0.3/index.js";
import {
...
export class AutocratClient {
  ...
  public readonly autocrat: Program<AutocratIDLType>;
  ...
  constructor(
    ...
    this.autocrat = new Program<AutocratIDLType>(
      AutocratIDL,
      autocratProgramId,
      provider,
    );
